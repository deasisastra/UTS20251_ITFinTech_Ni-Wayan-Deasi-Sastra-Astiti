...
const CustomerItem = ({
  ...
  name = "Laura",
  testimonial =
    "The food from BiteBox was absolutely delicious! Everything arrived warm and perfectly packed. I love how quick and easy the ordering process is — definitely my go-to choice for busy days.",
}) => {
  return (
    <div className="mt-5 mx-4">
      <div className="p-6 bg-secondary text-white rounded-[5px]">
        ...
        <div className="flex flex-col mt-4">
          ...
          <span className="text-[15px]">Customer from Jakarta</span>
        </div>
      </div>
